  ...
  <head>
	...
	<style type="text/css">
		* {
		...
		#logo1 {
			width: 120px;
			height: 60px;
			background: url("/ssm/img/logo.png") no-repeat;
		}
		#logo2 {
			width: 870px;
			height: 60px;
	...
	<script type="text/javascript">
		...
		function changeImg(){
			...
			img.style.backgroundImage="url(/ssm/img/" + imgArr[currentImg] + ")";
		};
	</script>
  </head>
    	...
    	<div id="c_login">
    		<form action="<%=request.getContextPath() %>/user/login" method="post" id="form">
	    		<table width="350px" cellpadding="0" cellspacing="0">
	    			...
	    			<tr>
	    				<td>
	    					<input type="text" name="username" value="用户名/手机号" id="username" class="in" autocomplete="off">
	    					<span class="error">*用户名不正确</span>
	    				</td>
	    			</tr>
	    			<tr>
	    				<td>
